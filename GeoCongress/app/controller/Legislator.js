...
Ext.define('GeoCon.controller.Legislator', {
    ...
    onLegislatorShow: function(container, newActiveItem, oldActiveItem, eOpts) {
    ...
    onBillListActivate: function(container, newActiveItem, oldActiveItem, eOpts) {
    ...
    onVoteListActivate: function(container, newActiveItem, oldActiveItem, eOpts) {
